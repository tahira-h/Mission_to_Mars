...
# Without browser.quit(), the browser will not know when to shut down. It will continue to listen for instructions and use the computer's resources, putting a strain on memory or laptop/computer.
